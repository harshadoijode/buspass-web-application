...
<p align="center" class="style1"><strong>User Registration Form</strong></p>
...
try{
int x=stmt.executeUpdate("insert into users  value('"+request.getParameter("s1")+"','"+request.getParameter("s2")+"','"+request.getParameter("s3")+"','"+request.getParameter("s4")+"')");
if(x!=0){
